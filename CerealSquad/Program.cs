...
namespace CerealSquad
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            awaiter.Add(ftpDownloader.RequireFile("jackHunter", "Assets/Character/JackHunter.png", new Uri(Downloaders.FTPDownloader.FTP_PATH + "Assets/Character/JackHunter.png"), true));
            ...
            awaiter.Add(ftpDownloader.RequireFile("S_CharacterSelect", "Assets/Music/CharacterSelection.ogg", new Uri(Downloaders.FTPDownloader.FTP_PATH + "Assets/Music/CharacterSelection.ogg"), false));
